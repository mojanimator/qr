...
(function (factory) {
    ...
    var defaults = {
        ...
        accept: function accept() {
            ...
            function validateForm() {
                if (selectionExists) return true;
        ...
        format: function format(filename) {
    ...
    $.ezdz = function (element, options) {
        ...
        var init = function init() {
            ...
            // Build the container
            $container = $('<div class="' + settings.classes.main + '" />').on('dragover.ezdz', function () {
    ...
    $.ezdz.prototype.preview = function (path, callback) {
        ...
        if (!path) {
            $ezdz.removeClass([settings.classes.enter, settings.classes.reject, settings.classes.accept].join(' ')).find('div').html(settings.text);
...
//# sourceMappingURL=jquery.ezdz.js.map