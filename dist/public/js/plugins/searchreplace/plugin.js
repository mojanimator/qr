...
(function () {
  ...
  function findAndReplaceDOMText(regex, node, replacementNode, captureGroup, schema) {
    ...
    function genReplacer(nodeName) {
      ...
      if (typeof nodeName !== 'function') {
        ...
        makeReplacementNode = function makeReplacementNode(fill, matchIndex) {
  ...
  var markAllMatches = function markAllMatches(editor, currentSearchState, regex) {
    var node, marker;
  ...
  var find = function find(editor, currentSearchState, text, matchCase, wholeWord) {
    text = text.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, '\\$&');
  ...
  var next = function next(editor, currentSearchState) {
    ...
    currentSearchState.set(_assign(_assign({}, currentSearchState.get()), { index: index }));
  };
