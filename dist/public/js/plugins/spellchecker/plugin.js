...
(function (domGlobals) {
  ...
  var get = function get(editor, startedState, lastSuggestionsState, textMatcherState, currentLanguageState, url) {
    ...
    var markErrors = function markErrors(data) {
      Actions.markErrors(editor, startedState, textMatcherState, lastSuggestionsState, data);
    };
    var getTextMatcher = function getTextMatcher() {
      return textMatcherState.get();
    };
    return {
