...
(function (domGlobals) {
  ...
  var isValue = function isValue(obj) {
    return obj !== null && obj !== undefined;
  };
  var traverse = function traverse(json, path) {
    var value;
  ...
  var requestUrlAsBlob = function requestUrlAsBlob(url, headers, withCredentials) {
  ...
  var isServiceErrorCode = function isServiceErrorCode(code) {
  ...
  var handleServiceError = function handleServiceError(status, blob) {
