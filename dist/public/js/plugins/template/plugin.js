...
(function () {
  ...
  var getTemplates = function getTemplates(editorSettings) {
  ...
  var createTemplateList = function createTemplateList(editorSettings, callback) {
    return function () {
  ...
  var insertTemplate = function insertTemplate(editor, ui, html) {
    var el;
    var n;
    var dom = editor.dom;
