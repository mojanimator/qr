...
(function () {
  ...
  var tab$1 = function tab$1(editor) {
    var availablePlugins = function availablePlugins() {
      var premiumPlugins = ['Accessibility Checker', 'Advanced Code Editor', 'Case Change', 'Checklist', 'Tiny Comments', 'Tiny Drive', 'Enhanced Media Embed', 'Format Painter', 'Link Checker', 'Mentions', 'MoxieManager', 'Page Embed', 'Permanent Pen', 'PowerPaste', 'Spell Checker Pro'];
