...
(function (domGlobals) {
  ...
  var removeDraft = function removeDraft(editor, fire) {
  ...
  var storeDraft = function storeDraft(editor) {
    var prefix = getAutoSavePrefix(editor);
  ...
  var restoreDraft = function restoreDraft(editor) {
    var prefix = getAutoSavePrefix(editor);
    if (hasDraft(editor)) {
  ...
  var startStoreDraft = function startStoreDraft(editor, started) {
  ...
  var makeSetupHandler = function makeSetupHandler(editor, started) {
    return function (api) {
  ...
  var register = function register(editor, started) {
