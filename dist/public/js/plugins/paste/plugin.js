...
(function (domGlobals) {
  ...
  var openContainer = function openContainer(rootTag, rootAttrs) {
    ...
    var attrs = [];
    var tag = '<' + rootTag;
    if ((typeof rootAttrs === 'undefined' ? 'undefined' : _typeof(rootAttrs)) === 'object') {
  ...
  var _pasteText = function _pasteText(editor, text) {
  ...
  var _pasteImageData = function _pasteImageData(editor, e, rng) {
  ...
  var _create = function _create(editor, lastRngCell, pasteBinDefaultContent) {
    var dom = editor.dom,
        body = editor.getBody();
    var pasteBinElm;
  ...
  var _remove = function _remove(editor, lastRngCell) {
    if (_getEl(editor)) {
  ...
  var _getEl = function _getEl(editor) {
    return editor.dom.get('mcepastebin');
  };
  var _getHtml = function _getHtml(editor) {
  ...
  var _getLastRng = function _getLastRng(lastRng) {
    return lastRng.get();
  };
  var _isDefaultContent = function _isDefaultContent(pasteBinDefaultContent, content) {
    return content === pasteBinDefaultContent;
  };
  var isPasteBin = function isPasteBin(elm) {
    return elm && elm.id === 'mcepastebin';
  };
  var _isDefault = function _isDefault(editor, pasteBinDefaultContent) {
