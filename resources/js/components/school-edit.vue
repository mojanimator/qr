...
//            this.getSchools();
            ...
            this.sName = this.selectedSchool.name ? this.selectedSchool.name : "";
            this.code_madrese = this.selectedSchool.code_madrese ? this.selectedSchool.code_madrese : "";
            this.code_faza = this.selectedSchool.code_faza ? this.selectedSchool.code_faza : "";
            this.sale_tasis = this.selectedSchool.sale_tasis ? this.selectedSchool.sale_tasis : "";
            this.tedad_daneshamooz = this.selectedSchool.tedad_daneshamooz ? this.selectedSchool.tedad_daneshamooz : "";
            this.tedad_paye_tahsili = this.selectedSchool.tedad_paye_tahsili ? this.selectedSchool.tedad_paye_tahsili : "";
            this.tedad_hamkaran = this.selectedSchool.tedad_hamkaran ? this.selectedSchool.tedad_hamkaran : "";
            ...
            if (this.selectedSchool.schoolable_type === 'App\\Saabet') {
                ...
                if (this.selectedSchool.schoolable) {
                    this.loc1_address = this.selectedSchool.schoolable.address ? this.selectedSchool.schoolable.address : "";
                    this.loc1_fasele_az_shahrestan = this.selectedSchool.schoolable.fasele_az_shahrestan ? this.selectedSchool.schoolable.fasele_az_shahrestan : "";
...
//                console.log('Koochro');
                ...
                if (this.selectedSchool.schoolable) {
                    ...
                    this.loc1_fasele_az_shahrestan = this.selectedSchool.schoolable.fasele_az_shahrestan_yeylagh ? this.selectedSchool.schoolable.fasele_az_shahrestan_yeylagh : "";
                    ...
                    if (this.selectedSchool.schoolable.loc_yeylagh || this.selectedSchool.schoolable.loc_gheshlagh) {
                        this.loc1_lat_input = this.selectedSchool.schoolable.loc_yeylagh ? this.selectedSchool.schoolable.loc_yeylagh.split(',')[0] : "";
                        this.loc1_lon_input = this.selectedSchool.schoolable.loc_yeylagh ? this.selectedSchool.schoolable.loc_yeylagh.split(',')[1] : "";
                        this.loc2_lat_input = this.selectedSchool.schoolable.loc_gheshlagh ? this.selectedSchool.schoolable.loc_gheshlagh.split(',')[0] : "";
                        this.loc2_lon_input = this.selectedSchool.schoolable.loc_gheshlagh ? this.selectedSchool.schoolable.loc_gheshlagh.split(',')[1] : "";
                    }
                }
            }
...
//                        console.log(files.length);
            ...
            checkInputs(params) {
                ...
                if (this.sName && this.sName.length > 100)
...
//                console.log(this.recaptcha);
                axios.post(this.panelLink + '/edit', {
